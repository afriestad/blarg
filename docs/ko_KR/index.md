...
또한, 표 아래에는 파편의 세 가지 윤곽 도면이 있습니다. 이 중 하나를 가리키는 것은, 동상의 On버튼과 거의 유사한 위치를 가르키고 있으며, 네 개의 나열된 점과 연결되어 있습니다. 이 점들 중 세 번째는 점이 채워져 있습니다. 파편의 세 번째 모드는 코드 모드이며, 이는 파편이 이 퍼즐에 대한 해결책의 일부일 가능성이 높다는 것을 뜻합니다!
